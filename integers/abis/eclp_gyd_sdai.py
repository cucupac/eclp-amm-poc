ABI = [
    {
        "inputs": [
            ...
            {"internalType": "address", "name": "configAddress", "type": "address"},
        ],
    ...
    },
    {
        ...
        "inputs": [
            {
                "components": [
                    {"internalType": "bool", "name": "capEnabled", "type": "bool"},
                    {
                        "internalType": "uint120",
                        "name": "perAddressCap",
                        "type": "uint120",
                    },
                    {"internalType": "uint128", "name": "globalCap", "type": "uint128"},
                ],
                "indexed": False,
                "internalType": "struct ICappedLiquidity.CapParams",
                "name": "params",
    ...
    {"anonymous": False, "inputs": [], "name": "UnpausedLocally", "type": "event"},
    {
        "inputs": [],
    ...
    {
        "inputs": [
            {"internalType": "address", "name": "_pauseManager", "type": "address"}
        ],
    ...
    },
    {
        ...
        "name": "getMiscData",
        "outputs": [
            {"internalType": "int256", "name": "logInvariant", "type": "int256"},
            {"internalType": "int256", "name": "logTotalSupply", "type": "int256"},
            {
                "internalType": "uint256",
    ...
    },
    {
        ...
        "name": "getTokenRates",
        "outputs": [
            {"internalType": "uint256", "name": "rate0", "type": "uint256"},
            {"internalType": "uint256", "name": "rate1", "type": "uint256"},
        ],
        "stateMutability": "view",
        "type": "function",
    },
    ...
    },
    {
        ...
        "name": "gyroConfig",
        "outputs": [
            {"internalType": "contract IGyroConfig", "name": "", "type": "address"}
        ],
        "stateMutability": "view",
        "type": "function",
    },
